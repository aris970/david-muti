...
function setUniform(job, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			...
			if job == 'bullet_wear' or job == 'fib_wear' then
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('fib_wear'),     value = 'fib_wear' },
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'fib_wear' or
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						if distance <= 2.0 then
							...
							ESX.ShowNotification('It is not close enough to get married.')
						end
					...
					elseif action == 'give_weaponlic' then
...
Citizen.CreateThread(function()
	while true do
		...
		if IsHandcuffed then
			DisableAllControlActions(0, true) -- Disable all
			
			EnableControlAction(0, 249, true) -- N Enable
